...
const ChatMessage = ({
  ...
  const thumbsDownIconBlack = (
    <svg
      ...
      strokeWidth="0"
    >
      <path d="M 2 3 L 2 15 L 5 15 L 5 3 L 2 3 z M 8.875 3 C 7.839 3 7 3.839 7 4.875 L 7 14.40625 C 7 14.90325 7.2115 15.398 7.5625 15.75 L 13.5625 21.75 C 13.5625 21.75 15.4375 21.28725 15.4375 19.53125 C 15.4385 18.85125 14 15 14 15 L 20 15 C 21.036 15 22 14.036 22 13 L 22 12.0625 C 22 11.6525 21.916 11.249 21.75 10.875 L 18.75 4.125 C 18.449 3.447 17.77225 3 17.03125 3 L 8.875 3 z" />
    </svg>
  );
